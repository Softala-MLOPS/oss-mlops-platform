...
The repository and CI/CD pipelines look like this after the default configuration installation. The staging branch is identical to the production branch. The default files can be found and changed in [CLI-tool/files/](https://www.google.com/search?q=./files/) folder.
